...
const platformIcons={facebook:["facebook","1877F2"],instagram:["instagram","E4405F"],tiktok:["tiktok","000000"],"tiktok ads":["tiktok","000000"],youtube:["youtube","FF0000"],twitter:["x","000000"],x:["x","000000"],discord:["discord","5865F2"],telegram:["telegram","26A5E4"],whatsapp:["whatsapp","25D366"],linkedin:["linkedin","0A66C2"],snapchat:["snapchat","FFFC00"],reddit:["reddit","FF4500"],pinterest:["pinterest","BD081C"],quora:["quora","B92B27"],github:["github","181717"],spotify:["spotify","1ED760"],grindr:["grindr","FEC016"],bumble:["bumble","FFC629"],badoo:["badoo","783BF9"],threads:["threads","000000"],twitch:["twitch","9146FF"],"private internet access":["privateinternetaccess","1E811F"],pia:["privateinternetaccess","1E811F"],expressvpn:["expressvpn","DA3940"],"express vpn":["expressvpn","DA3940"],"proton vpn":["protonvpn","6D4AFF"],protonvpn:["protonvpn","6D4AFF"],vpn:["protonvpn","6D4AFF"]};
function platformIcon(platform,fallback="★"){
  const key=String(platform||"").toLowerCase().trim(),entry=platformIcons[key];
  return entry?`<img class="platform-logo-img" src="https://cdn.simpleicons.org/${entry[0]}/${entry[1]}" alt="${esc(platform)}" loading="lazy" decoding="async">`:`<span>${esc(fallback)}</span>`;
}
...
function saveCart() {
  ...
  window.dispatchEvent(new Event("wayne:cart-change"));
}
